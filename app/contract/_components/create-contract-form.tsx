...
import { ContractFormFields, contractFormFieldsSchema } from "@/app/_core/models/models";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/app/_core/components/ui/card";
    ...
    return (
      <Card>
        ...
        <CardContent className="pt-8 space-y-8">
          <form onSubmit={handleSubmit(onFinalSubmit,(formErrors) => {
            console.error('Erros no formulário:', formErrors);
          })} className="space-y-8">
            <InputField label="Título do Contrato" id="title" type="text" register={register} error={errors.title} />
            <Section title="Dados do Contratado (Civil)">
              <InputField label="Nome" id="personContractorName" register={register} error={errors.personContractorName} />
              <CPFInput
                label="CPF" 
              ...
              />
              <InputField label="Email" id="personContractorEmail" type="email" register={register} error={errors.personContractorEmail} />
              <InputField label="Estado Civil" id="personContractorCivilStatus" register={register} error={errors.personContractorCivilStatus} />
              <InputField label="Profissão" id="personContractorProfession" register={register} error={errors.personContractorProfession} />
              <InputField label="RG" id="personContractorRG" register={register} error={errors.personContractorRG} />
              <InputField label="Endereço" id="personContractorCEP" register={register} error={errors.personContractorCEP} />
            </Section>
            <Section title="Dados da Contrante (Empresa)">
              <InputField label="Nome da Empresa" id="companyContractorName" register={register} error={errors.companyContractorName} />
              <InputField label="Nome do Sócio Administrador" id="companyContractorPersonName" register={register} error={errors.companyContractorPersonName} />
              <CPFInput
              ...
              id="companyContractorEmail" type="email" register={register} 
